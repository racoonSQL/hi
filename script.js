$(document).ready(function () {
  $('.box-body').on('click', function () {
    ...
    $('.box-lid').addClass('click2');
    $('.box-bowtie::before').addClass('click3');
    $('.box-bowtie::after').addClass('click4');
    $('.box').addClass('hide');
    ...
    setTimeout(function () {
      $('.rose').attr('href', './rose.png');
      $('title').html('Chúc mừng em ngày 8/3')
      $('.leftbg').addClass('openl1');
      $('.rightbg').addClass('openr1');
